...
public class ObjetivoTest {
	...
	public void associaPesquisa() {
		Pesquisa pesquisa = new Pesquisa("SEG1",
				"Chefes da mafia italiana aguardam extradicao no mesmo presidio que Marcola", "Seguranca publica");
	...
	public void associaComOutraPesquisaJaAssociada() {
		Pesquisa pesquisa = new Pesquisa("SEG1",
				"Chefes da mafia italiana aguardam extradicao no mesmo presidio que Marcola", "Seguranca publica");
		objetivo.associaPesquisa(pesquisa);
		Pesquisa pesquisa2 = new Pesquisa("SEG2", "extradicao no mesmo presidio que Marcola", "Seguranca publica");
	...
	void testBusca() {
		assertEquals(
				...
				objetivo.procuraPalavraChave("Diminuir"));
