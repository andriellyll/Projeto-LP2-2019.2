...
class AlunoTest {
	...
	void testToString() {
		...
		assertEquals("henrique (estudante) - henrique pfto - henrique@lemos - https://henrique - 3o SEMESTRE - 9.0", aluno.toString("henrique", "estudante", "henrique pfto", "henrique@lemos", "https://henrique"));
	}
	...
	void testSetSemestre() {
		...
		assertEquals("henrique (estudante) - henrique pfto - henrique@lemos - https://henrique - 4o SEMESTRE - 9.0", aluno.toString("henrique", "estudante", "henrique pfto", "henrique@lemos", "https://henrique"));
	}
	...
	void testSetIEA() {
		...
		assertEquals("henrique (estudante) - henrique pfto - henrique@lemos - https://henrique - 3o SEMESTRE - 9.7", aluno.toString("henrique", "estudante", "henrique pfto", "henrique@lemos", "https://henrique"));
	}
