...
public class ControllerBuscaTest {
	...
	void setUp() throws Exception {
		...
		controllerProblemaObjetivo.cadastraProblema(
				"primeira O problema do discurso homofobico em chats online de alunos de computacao de primeiro periodo",
				2);
		controllerProblemaObjetivo.cadastraObjetivo("GERAL",
				"primeira Diminuir a frequencia de mensagens homofobicas trocadas em chats online entre alunos de primeiro periodo de computacao.",
				4, 2);
		controllerAtividade.cadastraAtividade("primeira E so um teste hahahahahahahha", "ALTO",
	...
	public void testBuscaString() {
		controllerBusca = new ControllerBusca(controllerPesquisa, controllerPesquisador, controllerProblemaObjetivo,
				controllerAtividade);
		assertEquals(controllerBusca.busca("primeira"),
				"ECO1: Dolar fecha abaixo de R$ 4 pela primeira vez desde agosto | P1: primeira O problema do discurso homofobico em chats online de alunos de computacao de primeiro periodo | O1: primeira Diminuir a frequencia de mensagens homofobicas trocadas em chats online entre alunos de primeiro periodo de computacao. | A1: primeira E so um teste hahahahahahahha");
	}
	...
	public void testBuscaStringInt() {
		controllerBusca = new ControllerBusca(controllerPesquisa, controllerPesquisador, controllerProblemaObjetivo,
				controllerAtividade);
		assertEquals(controllerBusca.busca("primeira", 3),
				"O1: primeira Diminuir a frequencia de mensagens homofobicas trocadas em chats online entre alunos de primeiro periodo de computacao.");
	}
