...
class ProfessorTest {
	...
	void testToString() {
		...
		assertEquals("henrique (professor) - henrique pfto - henrique@lemos - https://henrique - Doutorado - UASC - 09/09/2009", prof.toString("henrique", "professor", "henrique pfto", "henrique@lemos", "https://henrique"));
	}
	...
	void testSetFormacao() {
		...
		assertEquals("henrique (professor) - henrique pfto - henrique@lemos - https://henrique - Mestrado - UASC - 09/09/2009", prof.toString("henrique", "professor", "henrique pfto", "henrique@lemos", "https://henrique"));
	}
	...
	void testSetData() {
		...
		assertEquals("henrique (professor) - henrique pfto - henrique@lemos - https://henrique - Doutorado - UASC - 07/07/2007", prof.toString("henrique", "professor", "henrique pfto", "henrique@lemos", "https://henrique"));
	}
	...
	void testSetUnidade() {
		...
		assertEquals("henrique (professor) - henrique pfto - henrique@lemos - https://henrique - Doutorado - DSC - 09/09/2009", prof.toString("henrique", "professor", "henrique pfto", "henrique@lemos", "https://henrique"));
	}
