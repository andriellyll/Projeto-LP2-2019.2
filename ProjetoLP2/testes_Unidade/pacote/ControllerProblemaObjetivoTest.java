...
public class ControllerProblemaObjetivoTest {
	...
	public void testCadastraProblema() {
		controllerProbObj.cadastraProblema(
				"O problema do discurso homofobico em chats online de alunos de computacao de primeiro periodo", 2);
	}
	...
	public void testCadastraProblemaViabilidadeInvalida() {
		assertThrows(IllegalArgumentException.class, () -> {
			controllerProbObj.cadastraProblema(
					"O problema do discurso homofobico em chats online de alunos de computacao de primeiro periodo",
					-1);
		});
		assertThrows(IllegalArgumentException.class, () -> {
			controllerProbObj.cadastraProblema(
					"O problema do discurso homofobico em chats online de alunos de computacao de primeiro periodo", 6);
		});
		assertThrows(IllegalArgumentException.class, () -> {
			controllerProbObj.cadastraProblema(
					"O problema do discurso homofobico em chats online de alunos de computacao de primeiro periodo", 0);
		});
	}

	@Test
	public void testCadastraObjetivo() {
		controllerProbObj.cadastraObjetivo("GERAL",
	...
	public void testCadastraObjetivoNull() {
		assertThrows(NullPointerException.class, () -> {
			controllerProbObj.cadastraObjetivo(null,
					"Diminuir a frequencia de mensagens homofobicas trocadas em chats online entre alunos de primeiro periodo de computacao.",
					4, 2);
		});
		assertThrows(NullPointerException.class, () -> {
	...
	public void testCadastraObjetivoVazio() {
		assertThrows(IllegalArgumentException.class, () -> {
			controllerProbObj.cadastraObjetivo("",
					"Diminuir a frequencia de mensagens homofobicas trocadas em chats online entre alunos de primeiro periodo de computacao.",
					4, 2);
		});
		assertThrows(IllegalArgumentException.class, () -> {
	...
	public void testApagarProblema() {
		String codigo = controllerProbObj.cadastraProblema(
				"O problema do discurso homofobico em chats online de alunos de computacao de primeiro periodo", 2);
	...
	public void testApagarObjetivo() {
		String codigo = controllerProbObj.cadastraObjetivo("GERAL",
				"Diminuir a frequencia de mensagens homofobicas trocadas em chats online entre alunos de primeiro periodo de computacao.",
				4, 2);
