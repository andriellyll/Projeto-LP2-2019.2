...
public class PesquisadorTest {
	...
	public void criaPesquisador() {
		pesquisador1 = new Pesquisador("Anna", "estudante", "gosta de matematica", "anna.lira@ccc.ufcg.edu.br",
				"https://annabeatrizlucena.com");
	...
	void criaPesquisNomeNulo() {
		assertThrows(NullPointerException.class, () -> {
			new Pesquisador(null, "estudante", "Perfeita demais", "andrielly11@ccc.ufcg.edu.br", "https://godspeed");
		});
	}
	...
	void criaPequisadorNomeVazio() {
		assertThrows(IllegalArgumentException.class, () -> {
			new Pesquisador("", "estudante", "Perfeita demais", "andrielly11@ccc.ufcg.edu.br", "https://godspeed");
		});
	...
	void criaPequisadorFuncaoNula() {
		assertThrows(NullPointerException.class, () -> {
			new Pesquisador("Andrielly", null, "Perfeita demais", "andrielly11@ccc.ufcg.edu.br", "https://godspeed");
		});
	...
	void criaPequisadorFuncaoVazia() {
		assertThrows(IllegalArgumentException.class, () -> {
			new Pesquisador("Andrielly", "", "Perfeita demais", "andrielly11@ccc.ufcg.edu.br", "https://godspeed");
		});
	...
	void criaPequisadorBiografiaNula() {
		assertThrows(NullPointerException.class, () -> {
			new Pesquisador("Andrielly", "estudante", null, "andrielly11@ccc.ufcg.edu.br", "https://godspeed");
		});
	...
	void criaPequisadorBiografiaVazia() {
		assertThrows(IllegalArgumentException.class, () -> {
			new Pesquisador("Andrielly", "estudante", "", "andrielly11@ccc.ufcg.edu.br", "https://godspeed");
		});
	...
	void criaPequisadorEmailNulo() {
		assertThrows(NullPointerException.class, () -> {
			new Pesquisador("Andrielly", "estudante", "Perfeita demais", null, "https://godspeed");
		});
	...
	void criaPequisadorEmailVazio() {
		assertThrows(IllegalArgumentException.class, () -> {
			new Pesquisador("Andrielly", "estudante", "Perfeita demais", "", "https://godspeed");
		});
	...
	void criaPequisadorUrlNula() {
		assertThrows(NullPointerException.class, () -> {
			new Pesquisador("Andrielly", "estudante", "Perfeita demais", "andrielly11@ccc.ufcg.edu.br", null);
		});
	...
	void criaPequisadorUrlVazia() {
		assertThrows(IllegalArgumentException.class, () -> {
			new Pesquisador("Andrielly", "estudante", "Perfeita demais", "andrielly11@ccc.ufcg.edu.br", "");
		});
	...
	void criaPequisadorEmailInvalido() {
		assertThrows(IllegalArgumentException.class, () -> {
			new Pesquisador("Andrielly", "estudante", "Perfeita demais", "drica@", "https://teste");
		});
		assertThrows(IllegalArgumentException.class, () -> {
			new Pesquisador("Andrielly", "estudante", "Perfeita demais", "@drica", "https://teste");
		});
		assertThrows(IllegalArgumentException.class, () -> {
			new Pesquisador("Andrielly", "estudante", "Perfeita demais", "a", "https://teste");
		});
	...
	void testSetNome() {
		...
		assertEquals(pesquisador1.toString(),
				"Bia (estudante) - gosta de matematica - anna.lira@ccc.ufcg.edu.br - https://annabeatrizlucena.com");
	}
	...
	void testSetBiografia() {
		...
		assertEquals(pesquisador1.toString(),
				"Anna (estudante) - gosta de ler - anna.lira@ccc.ufcg.edu.br - https://annabeatrizlucena.com");
	}
	...
	void testSetEmail() {
		...
		assertEquals(pesquisador1.toString(),
				"Anna (estudante) - gosta de matematica - beatriz.lucena@ccc.ufcg.edu.br - https://annabeatrizlucena.com");
	}
	...
	void testSetFoto() {
		...
		assertEquals(pesquisador1.toString(),
				"Anna (estudante) - gosta de matematica - anna.lira@ccc.ufcg.edu.br - https://beatrizlucena.com");
	}
	...
	void testSetFuncao() {
		...
		assertEquals(pesquisador1.toString(),
				"Anna (professor) - gosta de matematica - anna.lira@ccc.ufcg.edu.br - https://annabeatrizlucena.com");
	}
	...
	@Test
	void testHashCode() {
		Pesquisador pesquisador2 = new Pesquisador("Anna", "estudante", "gosta de matematica",
				"anna.lira@ccc.ufcg.edu.br", "https://annabeatrizlucena.com");
	...
	void testToString() {
		Pesquisador pesquisador2 = new Pesquisador("Anna", "estudante", "gosta de matematica",
				"anna.lira@ccc.ufcg.edu.br", "https://annabeatrizlucena.com");
		assertEquals(pesquisador2.toString(),
				"Anna (estudante) - gosta de matematica - anna.lira@ccc.ufcg.edu.br - https://annabeatrizlucena.com");
	}
	...
	void cadastraEspecialidadeProfessor() {
		Pesquisador pesquisador2 = new Pesquisador("eliane", "professor", "linda pfta", "eliane@computacao",
				"http://eliane");
		pesquisador2.cadastraEspecialidadeProfessor("Doutorado", "UASC", "07/07/2007");
		assertEquals(
				"eliane (professor) - linda pfta - eliane@computacao - http://eliane - Doutorado - UASC - 07/07/2007",
				pesquisador2.toString());
	}
	...
	void cadastraEspecialidadeProfessorPesquisadorIncompativel() {
		Pesquisador pesquisador3 = new Pesquisador("nishinoya", "externo",
				"melhor libero pfto quem discorda eh nazista", "nishinoya@lindo", "https://rollingthunder");
	...
	void cadastraEspecialidadeAluno() {
		...
		assertEquals(
				"Anna (estudante) - gosta de matematica - anna.lira@ccc.ufcg.edu.br - https://annabeatrizlucena.com - 1o SEMESTRE - 9.9",
	...
	void cadastraEspecialidadeAlunoPesquisadorIncompativel() {
		Pesquisador pesquisador3 = new Pesquisador("nishinoya", "externo",
				"melhor libero pfto quem discorda eh nazista", "kageyama@tobio", "https://rollingthunder");
		assertThrows(RuntimeException.class, () -> {
			pesquisador1.cadastraEspecialidadeProfessor("Doutorado", "UASC", "0707/2007");
		});
		assertThrows(RuntimeException.class, () -> {
	...
	void setEspecialidadeProfessor() {
		Pesquisador pesquisador2 = new Pesquisador("gauds", "professor", "gosta de cha de cha", "matheus@computacao",
				"http://matheus");
		pesquisador2.cadastraEspecialidadeProfessor("Doutorado", "UASC", "07/07/2007");
		assertEquals(
				"gauds (professor) - gosta de cha de cha - matheus@computacao - http://matheus - Doutorado - UASC - 07/07/2007",
				pesquisador2.toString());

		pesquisador2.setEspecialidade("formacao", "Pos-Doutorado");
		assertEquals(
				"gauds (professor) - gosta de cha de cha - matheus@computacao - http://matheus - Pos-Doutorado - UASC - 07/07/2007",
				pesquisador2.toString());

		pesquisador2.setEspecialidade("unidade", "DSC");
		assertEquals(
				"gauds (professor) - gosta de cha de cha - matheus@computacao - http://matheus - Pos-Doutorado - DSC - 07/07/2007",
				pesquisador2.toString());

		pesquisador2.setEspecialidade("data", "12/12/2012");
		assertEquals(
				"gauds (professor) - gosta de cha de cha - matheus@computacao - http://matheus - Pos-Doutorado - DSC - 12/12/2012",
				pesquisador2.toString());
	...
	void setEspecialidadeALuno() {
		...
		assertEquals(
				"Anna (estudante) - gosta de matematica - anna.lira@ccc.ufcg.edu.br - https://annabeatrizlucena.com - 1o SEMESTRE - 8.9",
				pesquisador1.toString());

		pesquisador1.setEspecialidade("semestre", "2");
		assertEquals(
				"Anna (estudante) - gosta de matematica - anna.lira@ccc.ufcg.edu.br - https://annabeatrizlucena.com - 2o SEMESTRE - 8.9",
				pesquisador1.toString());

		pesquisador1.setEspecialidade("IEA", "8.6");
		assertEquals(
				"Anna (estudante) - gosta de matematica - anna.lira@ccc.ufcg.edu.br - https://annabeatrizlucena.com - 2o SEMESTRE - 8.6",
				pesquisador1.toString());
